...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/scrape-youtube-comments?style=social)](https://github.com/data-scrape/scrape-youtube-comments)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/scrape-youtube-comments?style=social)](https://github.com/data-scrape/scrape-youtube-comments/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/scrape-youtube-comments)](https://github.com/data-scrape/scrape-youtube-comments/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/scrape-youtube-comments)](https://github.com/data-scrape/scrape-youtube-comments/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> Scrape YouTube comments - extract comments from any video


<!-- SEO keywords: scrape youtube comments, Scrape Youtube Comments, scrape youtube comments python, scrape youtube comments github -->
...
- Commenter username, text, timestamps
- Like count and reply count per comment
- Reply thread extraction (nested comments)
- Filter by keyword or sentiment
- Sort by top, newest, or most liked

## 🎯 Use Cases

Analyze audience sentiment, track brand mentions, extract feedback.
...
```bash
pip install git+https://github.com/data-scrape/scrape-youtube-comments.git
```

### From source

```bash
git clone https://github.com/data-scrape/scrape-youtube-comments.git
cd scrape-youtube-comments
pip install -e .
```
...
```python
from scrape_youtube_comments import Scraper
...
```bash
python scrape_youtube_comments.py --query "your-query" --output results.json
```
...
### Is Scrape Youtube Comments legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/scrape-youtube-comments)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/scrape-youtube-comments/issues)
