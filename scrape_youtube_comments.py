#!/usr/bin/env python3
"""
Scrape Youtube Comments - Scrape YouTube comments - extract comments from any video
"""
...
class Scraper:
    """Main scraper class for Scrape Youtube Comments."""
    ...
    def __init__(self, config=None):
        ...
        logger.info(f"ScrapeYoutubeComments initialized")
...
def main():
    import argparse
    p = argparse.ArgumentParser(description="Scrape Youtube Comments")
